Component({
  ...
  methods: {
    ...
    onEnd() {
      this.triggerEvent("changeColor", this.data.colorRes);
    },
    changeHue: function (e) {
      ...
      this.setData({
        ...
        colorRes: this.hsv2rgbRes(hue, this.data.hsv.s, this.data.hsv.v),
      });
    },
    changeSV: function (e) {
      let { x, y } = e.detail;
      ...
      this.setData({
        "hsv.s": x,
        "hsv.v": y,
        colorRes: this.hsv2rgbRes(this.data.hsv.h, x, y),
      });
    },
